...
public class ParkingSlotBookingService {
	public ParkingSlotBookingService(BookingRepository bookingRepository, UserRepository userRepository, VehicleRepository vehicleRepository, ParkingSlotRepository slotRepository) {
