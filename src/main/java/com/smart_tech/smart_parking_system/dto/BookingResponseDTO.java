...
public class BookingResponseDTO {
	...
	public BookingResponseDTO(Long bookingId, String vehicleNumber, String slotNumber, LocalDateTime startTime, LocalDateTime endTime, Long totalHours, Double totalAmount, BookingStatus status) {
